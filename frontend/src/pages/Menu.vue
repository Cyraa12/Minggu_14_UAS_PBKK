                ...
                <div class="row filter-section">
                    <ul class="filter-option">
                        <li>
                            ...
                            <label for="rtfPrice" class="d-flex justify-content-between">Rp 2.000 - Rp 5.000 <button
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rftPrice" value="5,10" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rftPrice" class="d-flex justify-content-between">Rp 5.000 - Rp 10.000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                        ...
                        <li>
                            <input type="button" name="rPrice" id="rttPrice" value="10,12" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="rttPrice" class="d-flex justify-content-between">Rp 10.000 - Rp 12.0000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
                        ...
                        <li>
                            <input type="button" name="rPrice" id="ltPrice" value="2" hidden
                                @click="filterPriceBtn($event)" />
                            <label for="ltPrice" class="d-flex justify-content-between">{{ "<" }} Rp 2.000 <button
                                    class="unselect-btn" @click="unselectPriceBtn($event)">X</button></label>
                        </li>
            ...
            <div class="col-sm-8">
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="tacoFilterFoodBtn" name="tacoFilterFoodBtn" class="menu-tab-item"
                            value="kopi" @click="filterFoodBtn($event)" />
                        ...
                        <input type="button" id="sidesFilterFoodBtn" name="sidesFilterFoodBtn" class="menu-tab-item"
                            value="snack" @click="filterFoodBtn($event)" />
                        ...
                        <input type="button" id="drinkFilterFoodBtn" name="drinkFilterFoodBtn" class="menu-tab-item"
                            value="rokok" @click="filterFoodBtn($event)" />
                    </div>
                </div>
                ...
                <div class="row box-container">
                    <div v-for="(f, index) in currentPageItems" :key="index">
                        <div class="box">
                            ...
                            <div class="content">
                                ...
                                <div class="price">
                                    Rp {{ parseFloat(f.food_price) - parseFloat(f.food_discount) }}.000
                                    <span v-if="parseFloat(f.food_discount) != 0.00">Rp {{ parseFloat(f.food_price)
                                    }}.000</span>
                                </div>
                                <button class="btn" @click="addItem(index)">Tambah ke keranjang</button>
                            </div>
                        </div>
                    </div>
                    <div v-if="!filterFoods.length">
                        <div class="box">
                            <div class="content">
                                <h1 style="color: #057835fa;">Tidak ditemukan!</h1>
                            </div>
                            <div class="image">

    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>+62 123 123 123</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-3.png" alt="">
                <h3>Jalan KopiBaru, Ketintang, Surabaya</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                <div class="input-box">
                    <label for="oPeople">Untuk Berapa Orang</label>
                ...
                <div class="input-box">
                    <label for="oTables">Butuh Berapa Meja</label>
            ...
            <div class="row">
                <div class="input-box">
                    <label for="uCard">Kartu Langganan Anda</label>
            ...
            <div class="row">
                <div class="input-box">
                    <label for="uMessage">Catatan</label>
                    <textarea placeholder="Atur Catatan Tambahan Anda Untuk Kami" name="uMessage" id="uMessage" cols="30"
                        rows="10" v-model="orderObj.note"></textarea>
                </div>
            </div>
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.orderObj.phone) {
                ...
                if (!this.orderObj.phone.startsWith('62')) {
            ...
            if (!this.orderObj.people) {
                this.errorObj.peopleErr.push("Harap Masukkan Berapa Jumlah Orang");
            }
            else {
                if (parseInt(this.orderObj.people) > 100) {
                    this.errorObj.peopleErr.push("Hanya Dapat Melayani 100 Orang Dalam Satu Waktu");
                }

                if (parseInt(this.orderObj.people) < 1) {
                    this.errorObj.peopleErr.push("Jumlah Orang Harus Lebih Besar Atau Sama Dengan 1");
                }
            }

            if (!this.orderObj.tables) {
                this.errorObj.tablesErr.push("Harap Masukkan Jumlah Meja");
            }
            else {
                if (parseInt(this.orderObj.tables) > 50) {
                    this.errorObj.tablesErr.push("Hanya Dapat Memiliki Maksimal 50 Meja");
                }

                if (parseInt(this.orderObj.tables) < 1) {
                    this.errorObj.tablesErr.push("Jumlah Meja Harus Lebih Besar Atau Sama Dengan 1");
                }

                if (parseInt(this.orderObj.people) < parseInt(this.orderObj.tables)) {
                    this.errorObj.tablesErr.push("Jumlah Meja Harus Lebih Sedikit Dari Jumlah Orang");
                }
            }

            if (this.orderObj.card) {
                if (!/[0-9]{10}/.test(this.orderObj.card)) {
                    this.errorObj.cardErr.push('Nomor Kartu Hanya Boleh Berisi Angka');
                }

                if (this.orderObj.card.length != 10) {
                    this.errorObj.cardErr.push('Nomor Kartu Harus Tepat 10 Digit');
                }
            }

            if (!this.orderObj.when) {
                this.errorObj.whenErr.push("Harap Masukkan Tanggal Reservasi");
            }
            else {
                ...
                if (dateInput.getTime() < dateMin.getTime() || dateInput.getTime() > dateMax.getTime()) {
                    this.errorObj.whenErr.push("Kisaran Reservasi Adalah Dari Sekarang Hingga Dua Bulan Ke Depan");
                }

                if (dateInput.getHours() < 7 || dateInput.getHours() > 22) {
                    this.errorObj.whenErr.push("Dibuka 24 Jam");
                }
            }
        ...
        async handleSubmit(e) {
            ...
            if (!this.checkEmptyErr()) {
                ...
                this.$refs.alert.showAlert('Sukses', 'Terima Kasih! Kami Akan Segera Menghubungi Untuk Mengkonfirmasi Reservasi Anda', 'Reservasi Sukses !')

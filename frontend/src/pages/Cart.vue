<template>
    <div class="shopping-cart-section">
        ...
        <div class="heading">
            <span>Keraanjang</span>
            <h3>Produk Terbaik, Pengiriman Cepat</h3>
        </div>
            ...
            <div class="wrapper wrapper-content">
                <div class="row">
                    <div class="in-cart col-md-9">
                        <div class="box">
                            ...
                            <div v-if="!filterFoods.length">
                                <div class="box-content row no-food">
                                    <div class="content">
                                        <h2 style="color: #057835fa;">Keranjang Kosong, Belanja Sekarang!</h2>
                                    </div>
                                    <div class="image">
                                        <img src="../assets/images/kosong.png" alt="" />
                                    </div>
                                </div>
                            </div>
                            <div v-else>
                        ...
                        <div class="box-content row">
                            <router-link to="/menu" class="btn shop-btn"><i class="fa fa-arrow-left"></i>Lanjutkan Belanja</router-link>
                            <button class="btn check-out-btn" style="margin-left: 10px;"
                                :disabled="filterFoods.length ? false : true" @click="checkOutBtn()"><i
                                    class="fa fa fa-shopping-cart"></i>Beli Sekarang</button>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="box">
                            ...
                            <div class="box-content">
                                <span>Total</span>
                                <h3 class="font-bold total-first-price">Rp {{ calculateSummaryPrice()[0] }}.000</h3>

                                <span>Diskon</span>
                                <h3 class="font-bold total-discount">Rp {{ calculateSummaryPrice()[1] }}.000</h3>

                                <span>Ongkir</span>
                                <h3 class="font-bold total-delivery">Rp {{ calculateSummaryPrice()[2] }}.000</h3>

                                <hr />

                                <span>Total</span>
                                <h2 class="font-bold total-sale">Rp {{ calculateSummaryPrice()[3] }}.000</h2>
                        ...
                        <div class="box">
                            ...
                            <div class="box-content text-center">
                                <h3><i class="fa fa-phone"></i> +62-821-1206-5957</h3>
                                <span class="small">
                                    Kita Tersedia 24 Jam
                                </span>
                            </div>
                        </div>
                    </div>
